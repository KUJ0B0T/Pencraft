...
데이터를 받을 모달에 넣은 코드
  ...
  비효율적인 하드코딩이기 때문에 추후 리팩토링 과제로 남김
  자바 스크립트에서 데이터를 주고 받기 위한 코드
  ```javascript
...
- Javascript와 jQuery의 기본적인 문법과 var, let, const 자료형에 대해 알게 되었음
- JpaRepository의 페이징의 기능의 사용법 습득
- 타임리프를 이용한 뷰페이지 표현과 로직 코드 사용법 습득
- 에러가 발생했을 때의 트러블 슈팅 능력 향상
> 아쉬운 점
- 검색 기능 및 정렬 기준을 설정할 수 있는 기능을 구현하지 못한 점
...
- 웹소켓에 대한 지식을 더 많이 쌓아서 활용하지 못한 점
<br>
